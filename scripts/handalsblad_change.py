...
models = {
    "1860-1899": Word2Vec.load("/scratchfast/jiaqiz/handalsblad/aligned/handelsblad_1860_1899.model"),
    "1900-1939": Word2Vec.load("/scratchfast/jiaqiz/handalsblad/aligned/handelsblad_1900_1939.model"),
    "1940-1959": Word2Vec.load("/scratchfast/jiaqiz/handalsblad/aligned/handelsblad_1940_1959.model")
}
...
# Save the plot
plt.savefig("handelsblad_semantic_change.png", dpi=300, bbox_inches='tight')
plt.show()
...
with open("handelsblad_semantic_change_results.txt", "w", encoding="utf-8") as f:
    f.write("HANDELSBLAD SEMANTIC CHANGE ANALYSIS RESULTS\n")
    f.write("=" * 60 + "\n\n")
...
print("  - 'handelsblad_semantic_change_results.txt' (detailed analysis)")
print("  - 'handelsblad_semantic_change.png' (plot)")
print("\n=== ANALYSIS COMPLETE ===")